...
permalink: /FAQ-marginmanual.html
date: 2014-06-10
---
...
So you're eager to do it yourself, notwithstanding the cautions
  outlined in ''[changing margins]({% post_url FAQ-changemargin %})''.
...
good LaTeX manuals (see [LaTeX books]({% post_url FAQ-latex-books %})). 
...
''[changing margins]({% post_url FAQ-changemargin %})''.
