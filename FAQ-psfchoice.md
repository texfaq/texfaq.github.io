...
[maths using OpenType fonts]({% post_url FAQ-otf-maths %}).
...
- Mathpazo version 1.003 (5 fonts) Diego Puga
  ...
  [PSNFSS]({% post_url FAQ-usepsfont %}); the fonts are
...
- MathTime Pro2Publish or Perish (Michael Spivak)
  ...
  [Personal TeX Inc]({% post_url FAQ-commercial %}).
...
implementations such as [TrueTeX]({% post_url FAQ-commercial %}) use TrueType
