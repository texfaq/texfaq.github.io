...
(see [books about TeX]({% post_url FAQ-tex-books %})) that it is
...
''[literate programming]({% post_url FAQ-lit %})'' to write TeX,
...
in the ports, Knuth supplied a [test]({% post_url FAQ-triptrap %}) by
...
program may be found in the 
  [TDS structured]({% post_url FAQ-tds %}) version of the distribution.
