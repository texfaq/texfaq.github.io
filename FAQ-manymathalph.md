...
permalink: /FAQ-manymathalph.html
date: 2014-06-10
---
...
to consider switching to use of [XeTeX]({% post_url FAQ-xetex %}) or
[LuaTeX]({% post_url FAQ-luatex %}), which both have 256 math alphabets
...
the [`bm`](https://ctan.org/pkg/bm) package to support [bold maths]({% post_url FAQ-boldgreek %}):
