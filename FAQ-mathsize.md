...
[TeXbook]({% post_url FAQ-tex-books %}) and in other books and
[tutorials]({% post_url FAQ-man-tex %}) that discuss Plain TeX in sufficient
detail.
...
[LaTeX abbreviations]({% post_url FAQ-ltxabbrv %}) for standard font sizes.
...
[internal commands]({% post_url FAQ-atsigns %}).
