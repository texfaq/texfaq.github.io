...
permalink: /FAQ-erroradvice.html
date: 2014-06-10
---
...
-  Look at TeX errors; those messages may seem cryptic at first,
    ...
    [the structure of errors]({% post_url FAQ-errstruct %}) for further
    details. 
...
-  As a last resort, tracing can be a useful tool; reading a full
    ...
    [books about TeX]({% post_url FAQ-tex-books %})) in some detail, fully
...
appeal to the [wider public]({% post_url FAQ-gethelp %})
