...
[`\indexname`]({% post_url FAQ-fixnam %}) is completely ignored.
...
[AMSLaTeX classes]({% post_url FAQ-AMSpkg %}), but the AMS provide a
...
[`\write18` commands]({% post_url FAQ-spawnprog %})&nbsp;&mdash; so as to simplify
