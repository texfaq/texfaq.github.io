...
about [typesetting URLs]({% post_url FAQ-setURL %}) still apply, so the
...
-  The [`babelbib`](https://ctan.org/pkg/babelbib) bundle, which offers 
    [multilingual bibliographies]({% post_url FAQ-i18nbib %}), similarly provides a
