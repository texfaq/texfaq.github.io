...
When we discussed 
[extending the number of arguments to a macro]({% post_url FAQ-moren9 %}), we
...
[the question mentioned above]({% post_url FAQ-moren9 %}), or the
...
The [`l3kernel`](https://ctan.org/pkg/l3kernel) programming layer for [LaTeX3]({% post_url FAQ-LaTeX3 %})
